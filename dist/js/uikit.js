...
(function (global, factory) {
    ...
    */
    ...
    function componentAPI (UIkit) {
        ...
        UIkit.component = function (name, options) {
            ...
            if (UIkit._initialized && !opt.functional) {
                fastdom.read(function () { return UIkit[name](("[mod-" + id + "],[data-mod-" + id + "]")); });
            }
    ...
    // register components
    each(components, function (component, name) { return UIkit$1.component(name, component); });
    ...
    each(components$1, function (component, name) { return UIkit$1.component(name, component); }
    );
